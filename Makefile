...
POWERPCOBJ = powerpc/targ.o powerpc/abi.o powerpc/isel.o powerpc/emit.o
RV64OBJ  = rv64/targ.o rv64/abi.o rv64/isel.o rv64/emit.o
OBJ      = $(COMMOBJ) $(AMD64OBJ) $(ARM64OBJ) $(POWERPCOBJ) $(RV64OBJ) 
...
check-powerpc: qbe
	TARGET=powerpc tools/test.sh all
